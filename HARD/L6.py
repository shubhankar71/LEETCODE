...
"+6e-1", "53.5e93", "-123.456e789", while the following are not valid numbers: "abc", "1a", "1e", "e3", "99e2.5", "--6", 
"-+3", "95a54e53".
...
4.An exponent is defined with an exponent notation 'e' or 'E' followed by an integer number.
